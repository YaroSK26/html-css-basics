<?php
    ...
    // Kontroluje data popř. přesměruje na chybovou adresu , prepis adrsu
    if (empty($name) OR empty($message) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        header("Location: https://www.alza.cz/index.html?success=-1#form");
        exit;
    }
    ...
    // Přesměrování na stránku, pokud vše proběhlo v pořádku , prepis adresu
    header("Location:https://www.alza.cz/index.html?success=1#form");
